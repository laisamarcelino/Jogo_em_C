...
typedef struct {
    ...
    ALLEGRO_BITMAP *projetil2, *projetil3, *projetil4, *projetil_boss1, *projetil_boss2, *projetil_boss1_especial; 
    unsigned short l1, a1, l2, a2, l3, a3, l4, a4, lb1, ab1, lb2, ab2;
    unsigned short lp2, lp3, lp4, lpb1, lpb2, ap2, ap3, ap4, apb1, apb2, apbe1, lpbe1;
} infos_inimigos;
